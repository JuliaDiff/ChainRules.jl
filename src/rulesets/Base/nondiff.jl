...
@non_differentiable accumulate(::Any, ::BitArray)
@non_differentiable accumulate!(::Any, ::Any, ::BitArray)
@non_differentiable Array(::BitArray)
@non_differentiable axes(::BitArray)
@non_differentiable axes(::BitArray, ::Int)
@non_differentiable conj(::BitArray)
@non_differentiable cumprod(::BitArray)
...
@non_differentiable eachindex(::BitArray)
@non_differentiable getindex(::BitArray, ::Any)
@non_differentiable IndexStyle(::BitArray)
@non_differentiable isassigned(::BitArray, ::Int)
@non_differentiable length(::BitArray)
@non_differentiable Matrix(::BitArray)
@non_differentiable ndims(::BitArray)
@non_differentiable similar(::BitArray, ::Any)
@non_differentiable size(::BitArray)
@non_differentiable size(::BitArray, ::Int)
@non_differentiable Vector(::BitArray)
